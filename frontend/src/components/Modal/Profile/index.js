      ...
      <div className="relative w-full max-w-md h-50 bg-light-gray">
        ...
        <div className="pl-6 bg-white mt-2">
          ...
          <div className="font-worksans pb-3 pl-3">
            ...
            {props.method == "search" ?
              <span className="flex-1" style={{ color: "#0033CC " }} >{props.Data.type == true ? props.Data.phone : "**********"}</span> :
              <span className="flex-1" style={{ color: "#0033CC " }} >{props.Data.phone}</span>
            }
          </div>
          <div className="font-worksans pb-3 pl-3">
            <span className="m-0">Email: </span>
            {props.method == "search" ?
              <span className="flex-1" style={{ color: "#0033CC " }} >{props.Data.typeRes == 0 ? props.Data.email : "**********"}</span> :
              <span className="flex-1" style={{ color: "#0033CC " }} >{props.Data.email}</span>
            }
          </div>
          <div className="font-worksans pb-3 pl-3">
