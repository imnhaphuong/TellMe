        ...
        <ul className="list p-0">
          <li className="blank flex">
            <a className="no-underline flex text-[#223645]" href="#chat">
              ...
              <div className="details">
                <h6 className=" truncate">JBieber</h6>
            ...
            <div className="contact-action flex">
              ...
              <button className="icon-btn border-none text-[18px]  text-success" onClick={()=>popUp('abc', "JBieber")}>
          ...
          <li className="blank flex">
            ...
            <div className="contact-action flex">
              ...
              <button className="icon-btn border-none text-[18px]  text-success" onClick={()=>popUp('qwe', 'Justin Bieber')}>
                <FiVideo className=" left-[25%] top-[25%] absolute" />
              </button>
            </div>
          </li>
          <li className="blank flex">
            <a className="no-underline flex text-[#223645]" href="#chat">
              <img className="bg-img" src={avt} alt="avt" />
              <div className="details">
                <h6 className=" truncate">Justin B</h6>
                <p className="text-[12px] truncate ">+2132131123</p>
              </div>
            </a>
            <div className="contact-action flex">
              ...
              <button className="icon-btn border-none text-[18px]  text-success" onClick={()=>popUp('zxc', 'JB')}>
                <FiVideo className=" left-[25%] top-[25%] absolute" />
              </button>
            </div>
          </li>
